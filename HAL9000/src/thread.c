    ...
    )
{
    ...
    if (!Process->PagingData->Data.KernelSpace)
    {
        ...
        {
            /*
            * 2. Process->PagingData->Data.KernelSpace is FALSE and bProcessIniialThread is TRUE
            *   We will access this part of code if our thread is the FIRST / MAIN thread created for a UserMode process.
            *   We need to make the distinction between the first and the others, because for the first thread we need to initialize
            *   the user stack
            */
        ...
        {
            /*
            * 2. Process->PagingData->Data.KernelSpace is FALSE and bProcessIniialThread is FALSE
            *   We will access this part of code if our thread is NOT the FIRST / MAIN thread created for a UserMode process.
            */
    ...
    {
        /*
        * 2. Process->PagingData->Data.KernelSpace is TRUE
        *   We will access this part of code if our thread is part of the Kernel mode
        */
        // Kernel mode
