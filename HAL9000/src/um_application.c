    ...
    )
{
    ...
    __try
    {
        ...
        /* 1.
        *   ->  The executable from the ProcessCreate function is loaded in the memory here by using the MmuLoadPe function
        */
        ...
        /*
        * 1.
        *   ->  Whenever we create a process we also create a thread because the thread will execute the process' function code. 
        *   But, when we create a thread, we won't create a new process. That would make create an infinte loop because our process will
        *   create a thread, which whill create a process and so on
        */
